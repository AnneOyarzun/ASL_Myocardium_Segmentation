...
def resnet_graph(input_image, architecture, stage5=False, train_bn=True, apply_dropout=False):
    """Build a ResNet graph.
        architecture: Can be resnet50 or resnet101
        stage5: Boolean. If False, stage5 of the network is not created
        train_bn: Boolean. Train or freeze Batch Norm layers
        apply_dropout: Boolean. Whether to apply dropout after each block
    """
...
def fpn_classifier_graph(rois, feature_maps, image_meta,
                         ...
                         fc_layers_size=1024, apply_dropout=False):
    ...
    apply_dropout: Boolean. Whether to apply dropout or not.
...
def load_image_gt(dataset, config, image_id, augmentation=None):
    ...
    mask = mask[:,:,_idx]
    class_ids = class_ids[_idx_][0:len(_idx)]
...
class MaskRCNN(object):
    ...
    def __init__(self, mode, config, model_dir, apply_dropout):
        """
    ...
    def build(self, mode, config):
        ...
        #    P5 = KL.Dropout(rate=0.5)(P5)  # Applying dropout after P5

        P4 = KL.Add(name="fpn_p4add")([
            KL.UpSampling2D(size=(2, 2), name="fpn_p5upsampled")(P5),
            KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (1, 1), name='fpn_c4p4')(C4)])
        #if self.apply_dropout:
        #    P4 = KL.Dropout(rate=0.5)(P4)  # Applying dropout after P4

        P3 = KL.Add(name="fpn_p3add")([
            KL.UpSampling2D(size=(2, 2), name="fpn_p4upsampled")(P4),
            KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (1, 1), name='fpn_c3p3')(C3)])
        #if self.apply_dropout:
            #P3 = KL.Dropout(rate=0.5)(P3)  # Applying dropout after P3

        P2 = KL.Add(name="fpn_p2add")([
            KL.UpSampling2D(size=(2, 2), name="fpn_p3upsampled")(P3),
            KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (1, 1), name='fpn_c2p2')(C2)])
        #if self.apply_dropout:
        #    P2 = KL.Dropout(rate=0.5)(P2)  # Applying dropout after P2
